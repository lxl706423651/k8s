...
MANIFEST=""
DEPLOY_BATCH_SIZE=40
DEPLOY_BATCH_SLEEP_SECONDS=5
DEPLOY_SUBNET_BATCH_SIZE=100
DEPLOY_SUBNET_BATCH_SLEEP_SECONDS=2
...
DEPLOY_PRESSURE_CHECK_SECONDS=15
DEPLOY_STABILIZE_TIMEOUT_SECONDS=36000
DEPLOY_MAX_PENDING_PODS=200
DEPLOY_MAX_CREATING_PODS=200
DEPLOY_MAX_NOTREADY_PODS=300
...
if [ "${DEPLOY_RESUME_EXISTING}" = "true" ]; then
    echo "Resume mode: skipping CRD/foundation re-apply."
