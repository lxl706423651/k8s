#!/usr/bin/env bash
# Wait until every Pod in the b63 experiment namespace is Running and Ready.
#
# Inputs: explicit experiment, kubeconfig, namespace, and wait parameters.
# Outputs: wait-ready.log under the experiment directory.
# Side effects: read-only kubectl polling.
# Context: run after deploy.sh.
set -euo pipefail
