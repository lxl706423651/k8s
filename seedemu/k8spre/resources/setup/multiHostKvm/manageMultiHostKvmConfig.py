#!/usr/bin/env python3
"""Parse and render multi-hypervisor KVM plans for K8sPre.
...
files and the global configK3s.yaml consumed by buildK3sCluster.sh.
"""
        ...
        hosts.append(
            {
                ...
                "remoteWorkDir": str(
                    ...
                    or f"/tmp/seedemu-k8spre/{clusterName(data)}/{name}"
                ),
            }
        )
