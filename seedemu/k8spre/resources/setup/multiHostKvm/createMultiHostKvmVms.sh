...
#   - Global multiHostKvmState.yaml for destroyMultiHostKvmVms.sh.
#
# Execution context:
#   Run after prepareKvmHypervisors.sh. This script creates VMs on the target
...
copyVmSshKeyToHost() {
    ...
    #   $1=name, $2=ip, $3=connection, $4=ssh_user, $5=ssh_key.
    #
    # Remote hypervisors run kvm/createKvmVms.sh locally, so they need a local
