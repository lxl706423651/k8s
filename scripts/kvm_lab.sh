...
SEED_KVM_DISK_GB="${SEED_KVM_DISK_GB:-200}"
...
SEED_K3S_MASTER_VCPUS="${SEED_K3S_MASTER_VCPUS:-12}"
SEED_K3S_WORKER1_VCPUS="${SEED_K3S_WORKER1_VCPUS:-12}"
SEED_K3S_WORKER2_VCPUS="${SEED_K3S_WORKER2_VCPUS:-12}"

SEED_K3S_MASTER_MEMORY_MB="${SEED_K3S_MASTER_MEMORY_MB:-65536}"
SEED_K3S_WORKER1_MEMORY_MB="${SEED_K3S_WORKER1_MEMORY_MB:-65536}"
SEED_K3S_WORKER2_MEMORY_MB="${SEED_K3S_WORKER2_MEMORY_MB:-65536}"
