...
SEED_KVM_DISK_GB="${SEED_KVM_DISK_GB:-400}"
...
SEED_K3S_MASTER_VCPUS="${SEED_K3S_MASTER_VCPUS:-64}"
SEED_K3S_WORKER1_VCPUS="${SEED_K3S_WORKER1_VCPUS:-64}"
SEED_K3S_WORKER2_VCPUS="${SEED_K3S_WORKER2_VCPUS:-64}"

SEED_K3S_MASTER_MEMORY_MB="${SEED_K3S_MASTER_MEMORY_MB:-150000}"
SEED_K3S_WORKER1_MEMORY_MB="${SEED_K3S_WORKER1_MEMORY_MB:-150000}"
SEED_K3S_WORKER2_MEMORY_MB="${SEED_K3S_WORKER2_MEMORY_MB:-150000}"
