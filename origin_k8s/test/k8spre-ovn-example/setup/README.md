...
- K3s 配置: `/home/lxl/k8s/origin_k8s/test/k8spre-ovn-example/setup/configK3s.yaml`

`buildK3sCluster.sh` 成功后，可以直接使用：

```bash
export KUBECONFIG="/home/lxl/k8s/origin_k8s/test/k8spre-ovn-example/setup/seedemu-k3s.kubeconfig.yaml"
